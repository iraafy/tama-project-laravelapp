                    ...
                    @if (session()->has('login'))
                        <li class="nav-item">
                            <a class="nav-link" href="/logout">
                                <iconify-icon inline icon="clarity:logout-line" style="color: #592c75;"></iconify-icon>
                                Logout
                            </a>
                        </li>
                    @else
                        <li class="nav-item">
                            <a class="nav-link" href="/login">
                                <iconify-icon inline icon="clarity:login-line" style="color: #592c75;"></iconify-icon>
                                Login
                            </a>
                        </li>
                    @endif
