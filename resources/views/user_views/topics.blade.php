...
<div class="wrappers">
    ...
    <div id="content" class="p-4 m-4">
        ...
        <div class="row shadow mb-5 mt-5 bg-white rounded p-3">
            <br><br>
            ...
            @if (strlen($topicData['content']) <= 4000) <button id="myBtn" onclick="myFunction()" class="btn btn-outline-primary btn-sm" style="visibility: hidden;">Read More</button>
                @else
