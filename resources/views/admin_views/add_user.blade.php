            ...
            <form method="post" action="user">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3 d-grid">
                        <a class="btn btn-outline-primary" href="/add-user">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <label class="col-sm-3 col-form-label mt-3">Password</label>
                                                <input value="{{ $userData->password }}" type="password" class="form-control" name="password" placeholder="Password">
